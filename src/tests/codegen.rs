...
fn create_test_app() -> App {
    ...
    // Add Headers
    tab.request_headers.insert("Content-Type".to_string(), "application/json".to_string());
    tab.request_headers.insert("X-Custom-Header".to_string(), "custom_value".to_string());
